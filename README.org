...
public JsonResult<PageInfo<DemoVo>> demoList(DemoDto dto, PageParam page) {
    // dto 中写方法来生成跟数据库对应的 model, 方法中可以先做 web 层的数据校验
    PageReturn<Demo> pageInfo = demoService.pageList(dto.demo(), "abc", page);
...
public interface DemoService {
    ...
    PageInfo<Demo> pageList(Demo param, String name, PageParam page);
}
...
public class DemoServiceImpl implements DemoService {
    ...
    @Override
    public PageInfo<Demo> pageList(Demo param, PageParam page) {
